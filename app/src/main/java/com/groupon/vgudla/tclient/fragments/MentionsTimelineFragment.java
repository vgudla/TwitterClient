...
public class MentionsTimelineFragment extends TweetListFragment implements OnComposeListener {
    ...
    protected void getTimeline(final boolean refresh) {
        ...
        JsonHttpResponseHandler responseHandler = new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                Log.e(TAG, "Error retrieving timeline" + throwable.getStackTrace());
                hideProgressBar();
            }
        };
        ...
        twitterClient.getMentionsTimeline(responseHandler, TWEET_REQUEST_COUNT, maxId, sinceId, refresh);
        showProgressBar();
    }
}
